...
struct PhysicsComponent : public Component {
	float mass = 1.0f;
	MATH::Matrix4 rotationalInertia; //NOTE: This use to be Matrix3
	MATH::Vec3 pos;
	MATH::Vec3 vel;
	MATH::Vec3 accel;
